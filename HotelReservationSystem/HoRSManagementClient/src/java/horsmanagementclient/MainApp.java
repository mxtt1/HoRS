            ...
            while (response < 1 || response > 99) {
                ...
                if (response == 1) {
                    try {
                        ...
                        hotelOperationModule = new HotelOperationModule(employeeEntitySessionBeanRemote, roomTypeEntitySessionBeanRemote, roomEntitySessionBeanRemote, currentEmployeeEntity);
                        menuMain();
